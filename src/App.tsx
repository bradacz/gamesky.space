...
const I18N = {
  cs: {
    ...
    heroLead: 'Konec úmorného vypisování příkazů, manuálního ladění EMS paměti a konfliktů zvukových karet. GameSky.space přináší kompletní, deterministický správce DOSBoxu pro moderní macOS.',
    ...
    compareGoodTitle: 'Čisté, deterministické spouštění',
  ...
  en: {
    ...
    heroLead: 'Say goodbye to typing endless terminal commands, manually tuning EMS memory, and fighting audio IRQ conflicts. GameSky.space brings a complete, deterministic DOSBox manager for modern macOS.',
    ...
    compareGoodTitle: 'Clean, Deterministic Launching',
