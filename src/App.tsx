...
const I18N = {
  cs: {
    ...
    heroKicker: 'REPORTÁŽ MĚSÍCE • RUBRIKA: DOSBOX PRO MAC & RETRO COMPUTING',
    heroTitle1: 'Čas na 640 KB paměti a 256 barev.',
    heroTitleHighlight: 'Retro',
    heroTitle2: 'bez složité konfigurace.',
    heroLead: 'Konec úmorného vypisování příkazů, manuálního ladění EMS paměti a konfliktů zvukových karet. GameSky.space je nejlepší DOSBox pro Mac – kompletní a jednoduchý správce retro DOS her pro moderní macOS.',
  ...
  en: {
    ...
    btnBmcCard: 'Buy me a coffee',
    stickerBadge: '★ VERIFIED RUST & TAURI V2 CORE ★',
    heroKicker: 'FEATURE OF THE MONTH • SECTION: DOSBOX FOR MAC & RETRO COMPUTING',
    heroTitle1: 'Time for 640 KB Memory & 256 Colors.',
    heroTitleHighlight: 'Retro gaming',
    heroTitle2: 'without complex setup.',
    heroLead: 'Say goodbye to typing endless terminal commands, manually tuning EMS memory, and fighting audio IRQ conflicts. GameSky.space is the ultimate DOSBox for Mac – a complete, simple retro DOS game manager for modern macOS.',
